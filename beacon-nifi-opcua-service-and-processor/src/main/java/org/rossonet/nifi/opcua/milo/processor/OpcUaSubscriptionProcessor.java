package org.rossonet.nifi.opcua.milo.processor;
...
@CapabilityDescription("Subscription via OPC UA Client")
public class OpcUaSubscriptionProcessor extends AbstractProcessor {
