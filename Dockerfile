...
RUN ./gradlew clean generateTemplateNifiPlugin && mv /ar4kAgent/beacon-template-nifi-processor/build/libs/beacon-template-nifi-processor-*.nar /result/beacon-template-nifi-processor.nar
